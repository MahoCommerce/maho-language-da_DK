...
# Danish (da_DK) language pack for Maho ecommerce platform

This repository contains the da_DK language pack for the Maho e-commerce platform.
It provides localization support for the da_DK language and region.
...
```bash
composer require mahocommerce/maho-language-da_dk
```
